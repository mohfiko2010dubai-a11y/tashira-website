...
export const TIMELINE_EVENT_NAMES = [
  ...
  "INVOICE_DOWNLOAD_LINK_CREATED", "INVOICE_DOWNLOADED",
  "PROCESSING_STARTED", "GOVERNMENT_PROCESSING", "ADDITIONAL_DOCUMENTS_REQUESTED", "VISA_APPROVED", "VISA_ISSUED",
